...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AlarmManager alarm_manager1 = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
        alarm_manager1.set(AlarmManager.RTC_WAKEUP, cur_call.getTimeInMillis() , p1i);
...
//                try
//                {
//                    date = dateFormat.parse(event.getStart().getDateTime().toString());
...
//            }
            ...
            try
            {
                date = dateFormat.parse(arrayEvent.get(0).getStart().getDateTime().toString());
...
//
//            sevendayalarm.add(Calendar.DAY_OF_MONTH, date.getDay());
//            sevendayalarm.add(Calendar.MONTH, date.getMonth());
//            sevendayalarm.add(Calendar.YEAR, date.getYear());
//            sevendayalarm.add(Calendar.HOUR, date.getHours());
//            sevendayalarm.add(Calendar.MINUTE, date.getMinutes());
//
//            Intent intent = new Intent(MainActivity.this, ServiceReceiver.class);
//            PendingIntent pendingIntent = PendingIntent.getBroadcast(MainActivity.this, 001, intent, 0);
//
//            AlarmManager am = (AlarmManager)getSystemService(ALARM_SERVICE);
//            am.set(AlarmManager.RTC_WAKEUP, sevendayalarm.getTimeInMillis(), pendingIntent);

//            Toast.makeText(MainActivity.this, arrayEvent.size()+"", Toast.LENGTH_LONG).show();
            ...
            calender.setListener(new CompactCalendarView.CompactCalendarViewListener()
            {
                ...
                public void onDayClick(Date dateClicked)
                {
                    ...
                    if (event1.size() > 0)
                    {
                        ...
                        Toast.makeText(MainActivity.this, evt.getId(), Toast.LENGTH_LONG).show();
                    }
                }
